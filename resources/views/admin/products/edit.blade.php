            ...
            <div class="admin-card mb-4">
                ...
                <div class="admin-card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="plan_note" class="form-control" value="{{ old('plan_note', $product->plan_note) }}" placeholder="VD: Tài khoản dùng chung, Nâng cấp chính chủ...">
                    </div>
                    <div class="mb-3">
                ...
                <div class="admin-card-body">
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="form-check form-switch d-flex justify-content-between align-items-center p-2" style="background:var(--admin-bg); border-radius:8px; border:1px solid var(--admin-border);">
                            ...
                            <input class="form-check-input" type="checkbox" name="show_in_list" value="1" {{ old('show_in_list', $product->show_in_list ?? true) ? 'checked' : '' }} style="cursor:pointer; margin-left:0; float:none;">
                        </div>
                        <div class="form-check form-switch d-flex justify-content-between align-items-center p-2" style="background:var(--admin-bg); border-radius:8px; border:1px solid var(--admin-border);">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (initialSpecs && initialSpecs.length > 0) {
        ...
        // Fallback to pre-populate form with existing single columns if they exist
        const defaults = [
            ...
            { name: 'Năm thành lập', value: '{{ $product->founded ?? "" }}' },
